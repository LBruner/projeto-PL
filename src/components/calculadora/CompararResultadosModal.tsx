            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div className="flex items-center gap-3">
                                <div
                                    ...
                                    <ChartNoAxesCombined color={'white'} className="text-blue-400 w-5 h-5"/>
                                </div>
                                <div>
                        ...
                        {/*<div*/}
                        {/*    className="flex items-center justify-end gap-3 p-2 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 rounded-b-2xl">*/}
                        {/*    <button*/}
                        {/*        onClick={onClose}*/}
